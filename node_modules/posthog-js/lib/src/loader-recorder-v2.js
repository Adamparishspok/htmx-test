...
function initFetchObserver(cb, win, options) {
    ...
    var restorePatch = patch(win, 'fetch', function (originalFetch) {
        return function (url, init) {
            return __awaiter(this, void 0, void 0, function () {
                var req, res, networkRequest, after, before, requestHeaders_1, responseHeaders_1, body, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (shouldRecordBody('request', options.recordBody, requestHeaders_1)) {
                        ...
                        case 2:
                            ...
                            if (!shouldRecordBody('response', options.recordBody, responseHeaders_1)) return [3 /*break*/, 7];
                            body = void 0;
                            _b.label = 3;
                        case 3:
                            _b.trys.push([3, 5, , 6]);
