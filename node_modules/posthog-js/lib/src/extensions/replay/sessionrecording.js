...
var SessionRecording = /** @class */ (function () {
    function SessionRecording(instance) {
        ...
        this._recordCanvas = false;
        this._canvasFps = null;
        this._canvasQuality = null;
    ...
    SessionRecording.prototype.afterDecideResponse = function (response) {
        ...
        var receivedRecordCanvas = (_g = response.sessionRecording) === null || _g === void 0 ? void 0 : _g.recordCanvas;
        this._recordCanvas =
            _isUndefined(receivedRecordCanvas) || _isNull(receivedRecordCanvas) ? false : receivedRecordCanvas;
        var receivedCanvasFps = (_h = response.sessionRecording) === null || _h === void 0 ? void 0 : _h.canvasFps;
        this._canvasFps = _isUndefined(receivedCanvasFps) ? null : receivedCanvasFps;
        var receivedCanvasQuality = (_j = response.sessionRecording) === null || _j === void 0 ? void 0 : _j.canvasQuality;
        this._canvasQuality =
