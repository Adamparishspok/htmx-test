...
export var style = function (id, appearance) {
    var positions = {
        left: 'left: 30px;',
        right: 'right: 30px;',
...
export var createSingleQuestionSurvey = function (posthog, survey, question) {
...
export function setTextColors(parentEl) {
    var e_5, _a;
    try {
