...
import { BasicSurveyQuestion, LinkSurveyQuestion, MultipleSurveyQuestion, RatingSurveyQuestion, Survey, SurveyAppearance, SurveyQuestion, SurveyType } from '../../posthog-surveys-types';
export declare const style: (id: string, appearance: SurveyAppearance | null) => string;
export declare const createSingleQuestionSurvey: (posthog: PostHog, survey: Survey, question: SurveyQuestion) => HTMLFormElement | HTMLDivElement | null;
export declare const createMultipleQuestionSurvey: (posthog: PostHog, survey: Survey) => HTMLFormElement & {
    className: string;
    onsubmit: (e: Event) => void;
};
export declare const createRatingsPopup: (posthog: PostHog, survey: Survey, question: RatingSurveyQuestion, questionIndex: number) => HTMLFormElement | HTMLDivElement;
export declare const createOpenTextOrLinkPopup: (posthog: PostHog, survey: Survey, question: BasicSurveyQuestion | LinkSurveyQuestion, questionIndex: number) => HTMLFormElement | HTMLDivElement;
export declare const createMultipleChoicePopup: (posthog: PostHog, survey: Survey, question: MultipleSurveyQuestion, questionIndex: number) => HTMLFormElement | HTMLDivElement;
export declare const closeSurveyPopup: (surveyId: string, surveyPopup: HTMLFormElement) => void;
export declare function getTextColor(el: HTMLElement): "black" | "white";
export declare function setTextColors(parentEl: any): void;
export declare function showQuestion(n: number, surveyId: string, surveyType: SurveyType): void;
export declare function nextQuestion(currentQuestionIdx: number, surveyId: string, surveyType: SurveyType): void;
