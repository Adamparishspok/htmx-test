...
type Body = string | Document | Blob | ArrayBufferView | ArrayBuffer | FormData | URLSearchParams | ReadableStream<Uint8Array> | null;
...
declare class SessionRecording {
    ...
    private _recordCanvas;
    private _canvasFps;
    private _canvasQuality;
